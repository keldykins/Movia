...
function endQuiz() {
    ...
    let scoreCard = $("<div>").addClass("card-section").text(score);

    $("#scores").addClass("card-section").append(scoreCard);
    scoreQuiz();
...
$("#movieSearchBtn").on("click", function (event) {
    ...
    $.ajax({
        ...
        var releasedSince = $("<p>").text(`${moment().format("YYYY") - response.Year} year(s) since this movie came out!`);
